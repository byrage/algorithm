...
public class DevelopFeature {
    ...
    public static void main(String[] args) {
        DevelopFeature developFeature = new DevelopFeature();
        int[] answer = developFeature.solution(new int[] {93, 30, 55}, new int[] {1, 30, 5});
    ...
    public int[] solution(int[] progresses, int[] speeds) {
        ...
        while (!features.isEmpty()) {
            int finishedCount = 0;
            while (features.peek() != null && features.peek().isFinished()) {
                features.poll();
                finishedCount++;
            }
            ...
            features.forEach(Feature::addProgress);
        }
