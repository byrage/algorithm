...
3. smoky_makeup
 */
public class ClothesChoicer {

    public static void main(String[] args) {

        ClothesChoicer clothesChoicer = new ClothesChoicer();
        int answer = clothesChoicer.solution(new String[][]
    ...
    public int solution(String[][] clothes) {
        Map<String, List<String>> clothesMap = Arrays.stream(clothes)
                .collect(Collectors.toMap(k -> k[1], v -> newList(v[0]), this::mergeList));

        if (clothesMap.values().size() == 0) {
            return 0;
        }
